					...
					<div id="LeftArea" style="display: block;">
						...
						<ul class="menu">
							...
							<div class="submenu" id="LeftMenuID2" style="display: none;">
								<li><a href="../notice/admin_notice_list"><img src="../images/icon_title_left.png">&nbsp;공지사항 관리</a></li>
								<li><a href="../faq/admin_faq_list"><img src="../images/icon_title_left.png">&nbsp;FAQ관리</a></li>
								<li><a href="../oo/admin_oofnq_list"><img src="../images/icon_title_left.png">&nbsp;1:1문의</a></li>
