...
<body>
	...
	<section>
		<h1>제품 등록</h1>
		<form action="product_write" name="inputform" method="get"
			...
			<div id="input_form">
				<table border="1">
					...
					<tr>
						...
						<td><input type="text" name="p_img1"></td>
					</tr>
					<tr>
						<td>제품 이미지1</td>
						<!--<td><input type="file" name="p_img2"></td> -->
						<td><input type="text" name="p_img2"></td>
					</tr>
					<tr>
						<td>제품 이미지2</td>
						<!--<td><input type="file" name="p_img3"></td> -->
						<td><input type="text" name="p_img3"></td>
					</tr>
					<tr>
						<td>상세내용 이미지</td>
