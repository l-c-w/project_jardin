		...
		<div id="outbox">	
			...
			<div id="left">
				...
				<ul>
					...
					<li><a href="../community/comment_list" id="leftNavi2">사용후기</a></li>
			...
			<div id="contents">
				...
				<div id="mypage">
					...
					<div class="productTab normaltab">
						...
						<ul>
							<li><a href="../community/epilogue_list" class="on">포토 구매후기</a></li>
							<li class="last"><a href="../community/epilogue_list">상품평</a></li>
						</ul>	
					...
					<div class="checkDivTab">
						...
						<form action="epilogue_update_ok" method="post" id="ewo" name="fileForm" enctype="multipart/form-data">
					...
					<div class="btnArea">
						<div class="bCenter">
							<ul>																
								...
								<li><a href="#" onclick="document.getElementById('ewo').submit();" class="sbtnMini">수정</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
