...
<tr>
	<td style="width:700px;height:78px;padding:0;margin:0;vertical-align:top;">
		<p style="width:620px;margin:50px 0 0 38px;text-align:center;font-size:0;line-height:0;"><img src="../images/email/img_txt_refund01.jpg" alt="원두커피의 名家, JARDIN 주문이 취소되었습니다." /></p>
	</td>
</tr>
<tr>
	<td style="width:700px;padding:0;margin:0;vertical-align:top;">
		<p style="width:620px;margin:30px 0 0 38px;text-align:center;font-size:0;line-height:0;"><img src="../images/email/img_txt_payment02.jpg" alt="JARDIN SHOP을 이용해 주셔서 진심으로 감사드립니다." /></p>
...
<tr>
	<td style="width:700px;padding:0;margin:0;vertical-align:top;">
		<p style="width:620px;margin:30px 0 10px 38px;font-size:0;line-height:0;"><img src="../images/email/img_txt_payment03.jpg" alt="구매내역" /></p>
	</td>
</tr>
<tr>
	<td style="width:700px;padding:0;margin:0;vertical-align:top;">
		...
		<tr>
			<td colspan="2" style="width:407px;height:40px;padding:0;margin:0;vertical-align:middle;font-size:0;line-height:0;border-top:1px #5b524d solid;border-bottom:1px #5b524d solid;text-align:center;">
				<img src="../images/email/img_txt_payment04.jpg" alt="상품명/옵션" />
			</td>
			<td style="width:100px;height:40px;padding:0;margin:0;vertical-align:middle;font-size:0;line-height:0;border-top:1px #5b524d solid;border-bottom:1px #5b524d solid;text-align:center;">
				<img src="../images/email/img_txt_payment05.jpg" alt="수량" />
			</td>
			<td style="width:113px;height:40px;padding:0;margin:0;vertical-align:middle;font-size:0;line-height:0;border-top:1px #5b524d solid;border-bottom:1px #5b524d solid;text-align:center;">
				<img src="../images/email/img_txt_payment06.jpg" alt="구매일자" />
			</td>
		</tr>
		<tr>
			<td style="width:100px;padding:12px 0;margin:0;vertical-align:middle;font-size:12px;line-height:1.2;text-align:center;border-bottom:1px #d9d9d9 solid;">
				<img src="../images/email/img_payment_sample.jpg" alt="상품" />
			</td>
...
<tr>
	<td style="width:700px;padding:0;margin:0;vertical-align:top;">
		<p style="width:620px;margin:0 0 10px 38px;font-size:0;line-height:0;"><img src="../images/email/img_txt_payment08.jpg" alt="취소 결제 내역" /></p>
	</td>
</tr>
<tr>
	<td style="width:700px;padding:0;margin:0;vertical-align:top;">
				...
				<table width="305" cellpadding="0" cellspacing="0" align="center" style="margin:0;">
					<tr>
						<td style="padding:15px 0 5px 19px; color:#888;background:#f9f9f9;">
							<img src="../images/email/arrow.jpg">&nbsp;주문금액
						</td>
					...
					<tr>
						<td style="padding:5px 0 5px 19px; color:#888;background:#f9f9f9;">
							<img src="../images/email/arrow.jpg">&nbsp;배송비
						</td>
					...
					<tr>
						<td style="padding:5px 0 5px 19px; color:#888;background:#f9f9f9;">
							<img src="../images/email/arrow.jpg">&nbsp;포인트
						</td>
						<td style="padding:5px 20px 5px 0;color:#666;text-align:right;background:#f9f9f9;">
					...
					<tr>
						<td style="padding:5px 0 5px 19px; color:#888;background:#f9f9f9;">
							<img src="../images/email/arrow.jpg">&nbsp;할인쿠폰
						</td>
						<td style="padding:5px 20px 5px 0;color:#666;text-align:right;background:#f9f9f9;">
					...
					<tr>
						<td style="padding:5px 0 15px 19px; color:#888;background:#f9f9f9;border-top:1px #eeeeee solid;border-bottom:1px #dcdcdc soilid;">
							<img src="../images/email/arrow.jpg">&nbsp;<strong style="color:#444;">총 결제금액</strong>
						</td>
					...
					<tr>
						<td style="padding:20px 0 20px 19px; color:#888;background:#ffffff;border-top:1px #eeeeee solid;border-bottom:1px #dcdcdc soilid;" colspan="2">
							<img src="../images/email/arrow.jpg">&nbsp;결제 수단 : <span style="color:#666;">신용카드</span>  (<strong style="color:#444;">결제완료</strong>)
						</td>
					</tr>
				</table>
			</td>
				...
				<table width="306" cellpadding="0" cellspacing="0" align="center" style="margin:0;">
					<tr>
						<td style="padding:15px 0 5px 19px; color:#888;">
							<img src="../images/email/arrow.jpg">&nbsp;최소일
						</td>
					...
					<tr>
						<td style="padding:5px 0 5px 19px; color:#888;">
							<img src="../images/email/arrow.jpg">&nbsp;환불 방법
						</td>
					...
					<tr>
						<td style="padding:5px 0 5px 19px; color:#888;">
							<img src="../images/email/arrow.jpg">&nbsp;<strong style="color:#666;">환불 총액</strong>
						</td>
						<td style="padding:5px 20px 5px 0;color:#666;text-align:right;">
							<strong style="color:#f7703c;font-size:15px;">32,200</strong> 원
						</td>
		...
		<tr>
			<td style="width:305px;border-right:1px #dcdcdc solid;">
				<table width="305" cellpadding="0" cellspacing="0" align="center" style="margin:0;">
					...
					<tr>
						<td style="padding:20px 0 20px 19px; color:#888;background:#ffffff;border-top:1px #eeeeee solid;border-bottom:1px #dcdcdc soilid;" colspan="2">
							<img src="../images/email/arrow.jpg">&nbsp;결제 수단 : <span style="color:#666;">통장 입금</span> (<strong style="color:#f7703c">입금전</strong>)
						</td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td style="width:305px;border-right:1px #dcdcdc solid;">
				<table width="305" cellpadding="0" cellspacing="0" align="center" style="margin:0;">
					...
					<tr>
						<td style="padding:20px 0 20px 19px; color:#888;background:#ffffff;border-top:1px #eeeeee solid;border-bottom:1px #dcdcdc soilid;" colspan="2">
							<img src="../images/email/arrow.jpg">&nbsp;결제 수단 : <span style="color:#666;">통장 입금</span>  (<strong style="color:#444;">입금완료</strong>)
						</td>
					</tr>
				</table>
			</td>
...
<tr>
	<td style="width:700px;height:100px;padding:0;margin:0;vertical-align:top;">
		<p style="width:700px;margin:10px 0 50px 0;text-align:center;"><a href="#"><img src="../images/email/btn_jardin.jpg" alt="JARDIN 바로가기" /></a></p>
	</td>
</tr>
<tr>
